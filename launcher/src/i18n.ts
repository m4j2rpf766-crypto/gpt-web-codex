...
const en = {
  ...
  connectorMigrationNotice: "Upgrading from a Codex Native connector? Leave it untouched and create WebGPT Luna as a new connector. Do not rename or refresh the old connector.",
...
const zh: Record<keyof typeof en, string> = {
  ...
  connectorMigrationNotice: "从 Codex Native 连接器升级？请保留旧连接器不变，并新建名为 WebGPT Luna 的连接器。不要重命名或刷新旧连接器。",
