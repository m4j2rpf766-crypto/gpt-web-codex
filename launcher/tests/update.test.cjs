...
test("checksums and release URLs bind the exact expected asset", () => {
  ...
  assert.equal(
    validateReleaseAssetUrl(
      "https://github.com/m4j2rpf766-crypto/gpt-web-codex/releases/download/v1.2.0/launcher.zip",
      "1.2.0",
      "launcher.zip",
    ),
    "https://github.com/m4j2rpf766-crypto/gpt-web-codex/releases/download/v1.2.0/launcher.zip",
          ...
          assets: [
            {
              ...
              browser_download_url: "https://github.com/m4j2rpf766-crypto/gpt-web-codex/releases/download/v1.2.0/gpt-web-codex-1.2.0-linux-x64.AppImage",
            },
            {
              name: "checksums.txt",
              browser_download_url: "https://github.com/m4j2rpf766-crypto/gpt-web-codex/releases/download/v1.2.0/checksums.txt",
            },
          ],
        };
      },
